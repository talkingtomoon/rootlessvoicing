...
- **탐색** — 사전. 키·진행·폼을 고르면 ii–V–I 세 코드를 건반에서 확인/재생.
- **암기** — 전체 120개에서 N장(12/30/60/120) 랜덤 출제.
- **타입별** — quality × form 하나를 골라 그 **12루트만** 한 바퀴 (`itemsOf`). 한 종류를 12키에 굳힐 때.

암기/타입별은 `DrillRunner`(보관함 루프 실행부)를 공유한다 — 출제·채점·집계 UI를 복제하지 마라.
